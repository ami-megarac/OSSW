...
+++ uboot/oem/ami/standalone/cmd_nettest.c	2017-05-22 17:39:27.540255473 +0800
@@ -0,0 +1,98 @@
+/*
...
+++ uboot/oem/ami/standalone/cmd_slt.c	2017-05-22 17:26:13.467501475 +0800
@@ -0,0 +1,38 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/common_std.c	2017-05-22 17:40:45.623277489 +0800
@@ -0,0 +1,35 @@
+#include <common.h>
...
+++ uboot/oem/ami/standalone/common_std.h	2017-05-18 19:52:23.640184383 +0800
@@ -0,0 +1,3 @@
...
+++ uboot/oem/ami/standalone/Makefile	2017-05-23 11:39:59.630760931 +0800
@@ -0,0 +1,50 @@
+#
+# (C) Copyright 2013 
...
+++ uboot/oem/ami/standalone/nettest/cmd_nettest.c	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,421 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/COMMINF.H	2017-05-19 12:16:17.069572426 +0800
@@ -0,0 +1,1074 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/DEF_SPI.H	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,36 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/DRAM_SPI.c	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,79 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/entry.c	2017-05-22 17:40:10.457703475 +0800
@@ -0,0 +1,29 @@
+#include <common.h>
+#include <exports.h>
+#include "stdalone.h"
...
+++ uboot/oem/ami/standalone/nettest/IO.c	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,381 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/IO.H	2017-05-19 12:16:17.069572426 +0800
@@ -0,0 +1,70 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LAN9303.c	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,532 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LIB.c	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,189 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LIB.H	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,42 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LIB_SPI.H	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,24 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/MAC.c	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,2806 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/MAC.H	2017-05-18 16:32:26.861723995 +0800
@@ -0,0 +1,152 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/MACTEST.c	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,1318 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/Makefile	2017-05-22 17:08:21.521705476 +0800
@@ -0,0 +1,100 @@
+#
...
+
+#NETTEST
+SRCS	+= MACTEST.c DRAM_SPI.c IO.c LIB.c MAC.c NCSI.c PCI_SPI.c PHY.c SPIM.c LAN9303.c STDUBOOT.c
+
+#SLT
+SRCS	+= STRESS.c
+
...
+++ uboot/oem/ami/standalone/nettest/NCSI.c	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,950 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/NCSI.H	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,147 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PCI_SPI.c	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,84 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PHY.c	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,2381 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PHY.H	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,54 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PHYSPECIAL.H	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,34 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/SPIM.c	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,64 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/stdalone.c	2017-05-22 17:12:27.169705476 +0800
@@ -0,0 +1,43 @@
+#include "stdalone.h"
+#include "COMMINF.H"
+
...
+++ uboot/oem/ami/standalone/nettest/stdalone.h	2017-05-22 17:12:38.921705476 +0800
@@ -0,0 +1,12 @@
+#define CMD_MAX 5
+
+typedef struct {
...
+++ uboot/oem/ami/standalone/nettest/STDUBOOT.c	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,236 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/STDUBOOT.H	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,19 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/STRESS.c	2017-05-22 17:18:09.673705476 +0800
@@ -0,0 +1,148 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/stubs.c	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,237 @@
+#include <common.h>
+#include <exports.h>
+
...
+++ uboot/oem/ami/standalone/nettest/SWFUNC.H	2017-05-19 12:16:17.069572426 +0800
@@ -0,0 +1,264 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+//#define PHY_SPECIAL
+#ifdef PHY_SPECIAL
+#define    VER_NAME    "@2015/12/10 Verification PHY_SPECIAL"
+#else
+#define    VER_NAME    "Ver 0.67 version @2019/02/22 1419 for BCM54210E"
+#endif
+
+/* == Auto setting ==========================================  */
+/* ====  Support OS system                                     */
...
+++ uboot/oem/ami/standalone/nettest/TYPEDEF.H	2017-05-18 16:32:26.865721995 +0800
@@ -0,0 +1,114 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
