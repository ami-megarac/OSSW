...
int peci_cmd_rdpciconfiglocal(char dev_id, char target, char domain, char Xmit_Feedback, char awfcs, int *read_len, unsigned char*pecirdpcilocalreq, unsigned char *pecirdpcilocalres);
