--- u-boot-2013.07/common/env_spi.c	2017-08-15 15:59:40.288982266 -0400
+++ uboot/common/env_spi.c	2017-08-15 15:57:22.104969610 -0400
@@ -0,0 +1,167 @@
+/* 
...
+	int ret;
+
+#if defined(CONFIG_PILOT4) || defined(CONFIG_AST2400) || defined(CONFIG_AST2500) || defined(CONFIG_AST2530) || defined(CONFIG_TWO_STAGES_BOOTLOADER) || defined(CONFIG_HPE_GXP)
