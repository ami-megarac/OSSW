--- uboot/drivers/spiflash/macronix.c	2019-03-21 17:01:51.864159185 +0800
+++ uboot.new/drivers/spiflash/macronix.c	2019-03-25 20:19:31.461512362 +0800
@@ -37,7 +37,9 @@
...
+	retval = ctrl_drv->spi_transfer(bank,&code[0], 5,SPI_READ,&rdsfdp, 1,0);
