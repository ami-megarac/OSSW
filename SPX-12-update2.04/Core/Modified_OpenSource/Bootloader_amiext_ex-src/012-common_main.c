--- u-boot-2013.07/common/main.c	2013-07-23 17:28:13.000000000 +0530
+++ uboot.new/common/main.c	2019-06-10 15:36:10.773986504 +0530
@@ -40,6 +40,10 @@
...
+	char *env_sd = NULL;
+
+	env_sd = getenv("sdbootselector");
+	if(env_sd == NULL)
+	{
+		setenv("sdbootselector", "1");
+		saveenv();
+	}
+#endif
+
