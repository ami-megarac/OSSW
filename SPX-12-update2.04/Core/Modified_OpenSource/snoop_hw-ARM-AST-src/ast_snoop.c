...
#else /* !defined(GROUP_AST1070_COMPANION) */
		snoop_irq = GetIrqFromDT("ami_snoop", AST_SNOOP_IRQ);
        ret = request_irq(snoop_irq, ast_snoop_irq_handler, IRQF_SHARED, AST_SNOOP_DRIVER_NAME, (void *)(snoop_as_io_base[ch]+AST_SNOOP_DEV_ID_OFFSET));
#endif /* !defined(GROUP_AST1070_COMPANION) */
        if (ret) {
...
#else /* !defined(GROUP_AST1070_COMPANION) */
        free_irq(snoop_irq, (void *)(snoop_as_io_base[ch]+AST_SNOOP_DEV_ID_OFFSET));
#endif /* !defined(GROUP_AST1070_COMPANION) */
    }
	unregister_hw_hal_module(EDEV_TYPE_SNOOP, ast_snoop_hal_id);
}
