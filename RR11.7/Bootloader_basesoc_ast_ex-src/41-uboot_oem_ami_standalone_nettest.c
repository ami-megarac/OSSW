...
+++ uboot/oem/ami/standalone/cmd_nettest.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,92 @@
+/*
...
+++ uboot/oem/ami/standalone/Makefile	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,48 @@
+#
+# (C) Copyright 2013 
...
+++ uboot/oem/ami/standalone/nettest/cmd_nettest.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,421 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/COMMINF.H	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,1074 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/DEF_SPI.H	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,36 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/DRAM_SPI.c	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,79 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/entry.c	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,29 @@
+#include <common.h>
+#include <exports.h>
+#include "stdalone.h"
...
+++ uboot/oem/ami/standalone/nettest/IO.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,381 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/IO.H	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,70 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LAN9303.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,532 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LIB.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,189 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LIB.H	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,42 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/LIB_SPI.H	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,24 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/MAC.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,2806 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/MAC.H	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,152 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/MACTEST.c	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,1318 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/Makefile	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,96 @@
+#
...
+++ uboot/oem/ami/standalone/nettest/NCSI.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,950 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/NCSI.H	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,147 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PCI_SPI.c	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,84 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PHY.c	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,2381 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PHY.H	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,54 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/PHYSPECIAL.H	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,34 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/SPIM.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,64 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/stdalone.c	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,22 @@
+#include "stdalone.h"
+#include "COMMINF.H"
+
...
+++ uboot/oem/ami/standalone/nettest/stdalone.h	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,9 @@
+#define CMD_MAX 2
+
+typedef struct {
...
+++ uboot/oem/ami/standalone/nettest/STDUBOOT.c	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,236 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/STDUBOOT.H	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,19 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/stubs.c	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,237 @@
+#include <common.h>
+#include <exports.h>
+
...
+++ uboot/oem/ami/standalone/nettest/SWFUNC.H	2016-12-05 14:04:32.684074237 +0800
@@ -0,0 +1,264 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+++ uboot/oem/ami/standalone/nettest/TYPEDEF.H	2016-12-05 14:04:32.688074237 +0800
@@ -0,0 +1,114 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
