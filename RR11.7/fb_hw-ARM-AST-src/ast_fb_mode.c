...
uint32_t ast_fb_clk_table[] = {
	...
	((0x0E << 27) | (0x15 << 22) | (0x3D << 13) | (0x40)),		/* 00: VCLK25_175		*/		
	((0x0E << 27) | (0x15 << 22) | (0x31 << 13) | (0x3A)),		/* 01: VCLK28_322		*/
	((0x0E << 27) | (0x15 << 22) | (0x2F << 13) | (0x3E)),		/* 02: VCLK31_5 		*/
	((0x0E << 27) | (0x15 << 22) | (0x23 << 13) | (0x35)), 		/* 03: VCLK36			*/	
	((0x0E << 27) | (0x15 << 22) | (0x1D << 13) | (0x31)), 		/* 04: VCLK40			*/
	((0x0E << 27) | (0x15 << 22) | (0x1F << 13) | (0x41)), 		/* 05: VCLK49_5 		*/
	((0x0E << 27) | (0x15 << 22) | (0x17 << 13) | (0x31)), 		/* 06: VCLK50			*/
	((0x0E << 27) | (0x15 << 22) | (0x1F << 13) | (0x4A)), 		/* 07: VCLK56_25		*/
	((0x0E << 27) | (0x15 << 22) | (0x17 << 13) | (0x40)), 		/* 08: VCLK65			*/
	((0x0E << 27) | (0x15 << 22) | (0x0F << 13) | (0x31)), 		/* 09: VCLK75			*/
	((0x0E << 27) | (0x15 << 22) | (0x11 << 13) | (0x3A)), 		/* 0A: VCLK78_75		*/
	((0x0E << 27) | (0x15 << 22) | (0x0F << 13) | (0x3E)), 		/* 0B: VCLK94_5 		*/
	((0x0E << 27) | (0x15 << 22) | (0x0B << 13) | (0x35)), 		/* 0C: VCLK108			*/
	((0x0E << 27) | (0x15 << 22) | (0x0A << 13) | (0x3D)), 		/* 0D: VCLK135			*/
	((0x0E << 27) | (0x15 << 22) | (0x0B << 13) | (0x4E)), 		/* 0E: VCLK157_5		*/
	((0x0E << 27) | (0x15 << 22) | (0x07 << 13) | (0x35)), 		/* 0F: VCLK162			*/
#else
...
#if defined(SOC_AST2500)
	iowrite32(0x00003C24, dinfo->io + AST_GRAPHICS_THRES);
#else
...
#if defined(SOC_AST2500)
	iowrite32(0x585, dinfo->io + AST_SCU_D2PLL_EXT_PARAM_REG);
	iowrite32(ast_fb_clk_table[mode_info.clk_tab_index], dinfo->io + AST_SCU_D2PLL_PARAM_REG);
	iowrite32(0x580, dinfo->io + AST_SCU_D2PLL_EXT_PARAM_REG);
#else
