...
JBI_RETURN_TYPE jbi_set_drstop_state(JBIE_JTAG_STATE state)
{
...
JBI_RETURN_TYPE jbi_set_irstop_state(JBIE_JTAG_STATE state)
{
...
JBI_RETURN_TYPE jbi_set_dr_preamble(unsigned int count,	unsigned int start_index, unsigned char *preamble_data)
{
...
JBI_RETURN_TYPE jbi_set_ir_preamble(unsigned int count,	unsigned int start_index, unsigned char *preamble_data)
{
	JBI_RETURN_TYPE status = JBIC_SUCCESS;
	unsigned int i;
	unsigned int j;
...
JBI_RETURN_TYPE jbi_set_dr_postamble(unsigned int count, unsigned int start_index, unsigned char *postamble_data)
{
	JBI_RETURN_TYPE status = JBIC_SUCCESS;
	unsigned int i;
	unsigned int j;
...
JBI_RETURN_TYPE jbi_set_ir_postamble(unsigned int count, unsigned int start_index, unsigned char *postamble_data)
{
	JBI_RETURN_TYPE status = JBIC_SUCCESS;
	unsigned int i;
	unsigned int j;
...
JBI_RETURN_TYPE jbi_goto_jtag_state(JBIE_JTAG_STATE state)
{
	int tms;
	int count = 0;
	JBI_RETURN_TYPE status = JBIC_SUCCESS;
...
JBI_RETURN_TYPE jbi_do_wait_cycles(long cycles,	JBIE_JTAG_STATE wait_state)
{
	int tms;
	long count;
	JBI_RETURN_TYPE status = JBIC_SUCCESS;
...
int jbi_jtag_drscan(int start_state, int count, unsigned char *tdi, unsigned char *tdo)
{
	int i = 0;
	int tdo_bit = 0;
	int status = 1;
...
int jbi_jtag_irscan(int start_state, int count, unsigned char *tdi, unsigned char *tdo)
{
	int i = 0;
	int tdo_bit = 0;
	int status = 1;
...
void jbi_jtag_extract_target_data(unsigned char *buffer, unsigned char *target_data, unsigned int start_index, unsigned int preamble_count,	unsigned int target_count)
{
	unsigned int i;
	unsigned int j;
	unsigned int k;
...
JBI_RETURN_TYPE jbi_do_irscan(unsigned int count, unsigned char *tdi_data, unsigned int start_index)
{
	int start_code = 0;
...
JBI_RETURN_TYPE jbi_swap_ir(unsigned int count, unsigned char *in_data, unsigned int in_index, unsigned char *out_data, unsigned int out_index)
{
	int start_code = 0;
	unsigned int alloc_chars = 0;
	unsigned int shift_count = jbi_ir_preamble + count + jbi_ir_postamble;
...
JBI_RETURN_TYPE jbi_do_drscan(unsigned int count, unsigned char *tdi_data, unsigned long start_index)
{
	int start_code = 0;
	unsigned int alloc_chars = 0;
...
JBI_RETURN_TYPE jbi_swap_dr(unsigned int count, unsigned char *in_data, unsigned long in_index, unsigned char *out_data, unsigned int out_index)
{
	int start_code = 0;
	unsigned int alloc_chars = 0;
	unsigned int shift_count = jbi_dr_preamble + count + jbi_dr_postamble;
