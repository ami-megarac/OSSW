...
// GPIOG5 for TDO
 #define GPIO_EEGH_DATA_VALUE   0x20
 #define GPIO_EFGH_DIRECTION    0x24
 #define GPIO_G5_BIT            0x00200000 // need disable Watchdoag Time2 timeout pulse output.

// GPIOD6 for TDO pin
// 1. disable pass-through mode
// 2. Multi-function pin.

 #define GPIO_ABCD_DATA_VALUE	0x00
 #define GPIO_ABCD_DIRECTION    0x04
 #define GPIO_D6_BIT            0x40000000

 #define GPIO_DATA_VALUE        GPIO_EEGH_DATA_VALUE
 #define GPIO_DIRECTION         GPIO_EFGH_DIRECTION 
 #define GPIO_TDO_BIT           GPIO_G5_BIT
#endif
